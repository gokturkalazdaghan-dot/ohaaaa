 ...
 *
 * TEK İFADE, YARIŞSIZ. Yalnız EKSİK alanlar doldurulur
 * (`coalesce(mevcut, yeni)`): kanonik ürün birden çok feed'den beslenir ve
 * son gelenin ilk gelenin verisini EZMESİ, daha zengin bir kaydı daha
 * fakiriyle değiştirmek olurdu.
 */
