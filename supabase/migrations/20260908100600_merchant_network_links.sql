...
-- ---------------------------------------------------------------------------
-- `network` burada da 'direct' dâhil aynı değer kümesinden geliyor. Yarın
-- doğrudan marketplace seller onboarding'i eklendiğinde o satıcı da bir
-- merchant olur ve ağ bağı hiç açılmaz -- model affiliate'e kilitlenmiyor.
-- ===========================================================================
